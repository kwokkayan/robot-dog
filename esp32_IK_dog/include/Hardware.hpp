...
private:
  ...
  */
  ...
  {
    Console.println("< calibration parameters >");
    Console.println("accel bias [g]: ");
    Console.print(mpu.getAccBiasX() * 1000.f / (float)MPU9250::CALIB_ACCEL_SENSITIVITY);
    Console.print(", ");
    Console.print(mpu.getAccBiasY() * 1000.f / (float)MPU9250::CALIB_ACCEL_SENSITIVITY);
    Console.print(", ");
    Console.print(mpu.getAccBiasZ() * 1000.f / (float)MPU9250::CALIB_ACCEL_SENSITIVITY);
    Console.println();
    Console.println("gyro bias [deg/s]: ");
    Console.print(mpu.getGyroBiasX() / (float)MPU9250::CALIB_GYRO_SENSITIVITY);
    Console.print(", ");
    Console.print(mpu.getGyroBiasY() / (float)MPU9250::CALIB_GYRO_SENSITIVITY);
    Console.print(", ");
    Console.print(mpu.getGyroBiasZ() / (float)MPU9250::CALIB_GYRO_SENSITIVITY);
    Console.println();
    Console.println("mag bias [mG]: ");
    Console.print(mpu.getMagBiasX());
    Console.print(", ");
    Console.print(mpu.getMagBiasY());
    Console.print(", ");
    Console.print(mpu.getMagBiasZ());
    Console.println();
    Console.println("mag scale []: ");
    Console.print(mpu.getMagScaleX());
    Console.print(", ");
    Console.print(mpu.getMagScaleY());
    Console.print(", ");
    Console.print(mpu.getMagScaleZ());
    Console.println();
  }
  ...
  void update_mpu_data()
  {
    if (mpu.update())
    {
      static uint32_t mpu_timer_prev_ms = millis();
      if (millis() > mpu_timer_prev_ms + 25)
      {
        print_roll_pitch_yaw();
        mpu_timer_prev_ms = millis();
      }
    }
...
public:
  ...
  void init_mpu()
  {
    ...
    { // change to your own address
      while (1)
      {
        Console.println("MPU connection failed. Please check your connection with `connection_check` example.");
        delay(5000);
      }
    }
