...
void ps4_gap_init_services() {
  gap_handle_hidc = ps4_gap_init_service((char *)"PS4-HIDC", BT_PSM_HIDC, BTM_SEC_SERVICE_FIRST_EMPTY);
  gap_handle_hidi = ps4_gap_init_service((char *)"PS4-HIDI", BT_PSM_HIDI, BTM_SEC_SERVICE_FIRST_EMPTY + 1);
}
