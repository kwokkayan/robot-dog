...
int PWM_Servo::radiansToPWM(float rad, map_info_t map_info)
{
    return (int)round(mapfloat(rad, map_info.min_angle, map_info.max_angle, map_info.pulse_min, map_info.pulse_max));
}
