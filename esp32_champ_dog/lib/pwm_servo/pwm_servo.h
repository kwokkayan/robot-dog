...
private:
    ...
    joint_servo_map joint_servo = {
        ...
        {"rf_lower_leg_joint", {8, 0, RF_LOWER_LEG_JOINT_OFFSET, 1.0f, map_info}},
        // ## {shoulder chnl, upper chnl, lower chnl} robot's left front
        {"lh_hip_joint", {2, 0, LH_HIP_JOINT_OFFSET, -1.0f, map_info}},
        {"lh_upper_leg_joint", {1, 0, LH_UPPER_LEG_JOINT_OFFSET, 1.0f, map_info}},
        {"lh_lower_leg_joint", {0, 0, LH_LOWER_LEG_JOINT_OFFSET, -1.0f, map_info}},
        // ## {shoulder chnl, upper chnl, lower chnl} robot's left back
        {"rh_hip_joint", {13, 0, RH_HIP_JOINT_OFFSET, -1.0f, map_info}},
        {"rh_upper_leg_joint", {14, 0, RH_UPPER_LEG_JOINT_OFFSET, -1.0f, map_info}},
        {"rh_lower_leg_joint", {15, 0, RH_LOWER_LEG_JOINT_OFFSET, 1.0f, map_info}},
    };
