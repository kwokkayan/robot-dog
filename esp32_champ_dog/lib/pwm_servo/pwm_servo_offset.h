...
#define LF_HIP_JOINT_OFFSET 0.00f
#define LF_UPPER_LEG_JOINT_OFFSET 0.00f
#define LF_LOWER_LEG_JOINT_OFFSET LOWER_OFFSET

#define RF_HIP_JOINT_OFFSET 0.00f
#define RF_UPPER_LEG_JOINT_OFFSET 0.00f
#define RF_LOWER_LEG_JOINT_OFFSET LOWER_OFFSET

#define LH_HIP_JOINT_OFFSET 0.00f
#define LH_UPPER_LEG_JOINT_OFFSET 0.00f
#define LH_LOWER_LEG_JOINT_OFFSET LOWER_OFFSET

#define RH_HIP_JOINT_OFFSET 0.00f
#define RH_UPPER_LEG_JOINT_OFFSET 0.00f
#define RH_LOWER_LEG_JOINT_OFFSET LOWER_OFFSET 
